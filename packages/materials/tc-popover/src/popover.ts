      ...
      [
        createElement(
...

          {
            ...
            class: {
              'tc-popover': true,
              [`tc-popover--${currentPlacementAsObject.placement}`]: currentPlacementAsObject,
              [`tc-popover--${currentPlacement}`]: currentPlacement,
            },
          ...
          [
            ...
            title ? createElement(
              ...
              {
                class: 'tc-popover__header',
              },

              [createElement(utils.createComponent(title))],
            ) : '',
            ...
            createElement(
              ...
              {
                class: 'tc-popover__body',
              },

              content ? [createElement(utils.createComponent(content))] : this.$slots.default,
            ),
          ],
        ),
      ],
